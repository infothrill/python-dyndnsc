...
class Plugin(object):
    """Base class for plugins. It is recommended but not *necessary* to
...
class IPluginInterface(object):
    ...
    def options(self, parser, env):
        """Used to to register command line options for this plugin with the
        argparse parser.
    ...
    def initialize(self):
        """Called before any core activities are run. Use this to perform any
